...
- **camera**: Change the active camera to the one specified by the first numeric parameter,
  which is the camera ID. Start replay with the stream specified in the second numeric parameter
  unless it is zero.

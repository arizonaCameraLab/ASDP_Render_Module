...
namespace asdp {
  namespace render {
    ...
    /// @brief Manages a thread-safe pre-allocated pool of CUDA pinned CPU buffers.
    ...
    public:
      ...
      PinnedBufferPool(size_t bufferSize, size_t bufferCount);
      ...
      /// @brief Test the PinnedBufferPool class.

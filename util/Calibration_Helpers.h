...
/// @brief Compute the intersection of a ray through the specified pixel location with the plane at Z = -1.
...
/// the camera looking from the origin down the -Z axis with the Y axis up.  It ignores camera distortion.
/// @param cri The camera render information.

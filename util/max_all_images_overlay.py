...
def compute_max_image(directory):
    ...
    write_pgm_16bit('max.pgm', max_img)
    print(f"max.pgm written with shape {max_img.shape}")

# Example usage
if __name__ == '__main__':
    import sys
    if len(sys.argv) != 2:
        print("Usage: python pgm_max.py <directory>")
    else:
        compute_max_image(sys.argv[1])

...
extern int vrpn_open_commport(const char *portname, long baud, int charsize = 8,
...
/// @{
extern int vrpn_read_available_characters(int comm, unsigned char *buffer, size_t count);
extern int vrpn_read_available_characters(int comm,

...
int main()
{
  ...
  // exiting.
  {
    ...
    asdp::render::DisplayWindow window("Display_Test", composite, client, 0, 0, width, height);
    if (window.GetStatus() != "") {
    ...
    asdp::render::DisplayWindow window2("Display_Test2", composite, client, 0, 0, width, height,
      90, "", &window);
